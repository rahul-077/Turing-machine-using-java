...
if (nextTransition.readState.equals(CurrentState) && nextTransition.readSymbol
...
public boolean addTransition(String rState, char rSymbol, String wState, char wSymbol,
boolean mDirection)
{
